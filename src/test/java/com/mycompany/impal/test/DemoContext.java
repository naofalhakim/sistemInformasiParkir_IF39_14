...
public void menampilkan_visualisasi_dari_pemantauan_kendaraan() throws Throwable {
    // Write code here that turns the phrase above into concrete actions
...
public void akan_tampil_notofikasi_id_yang_di_inputkan_salah() throws Throwable {
    // Write code here that turns the phrase above into concrete actions
...
@Maka("^menampilkan lokasi spot kendaraan$")
public void menampilkan_lokasi_spot_kendaraan() throws Throwable {
    // Write code here that turns the phrase above into concrete actions
    
}

@Maka("^akan tampil notifikasi id yang di inputkan salah$")
public void akan_tampil_notifikasi_id_yang_di_inputkan_salah() throws Throwable {
    // Write code here that turns the phrase above into concrete actions
